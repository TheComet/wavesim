...
#define VECTOR_ERROR (uintptr_t)-1

typedef struct vector_t
{
    uintptr_t element_size;  /* how large one element is in bytes */
    uintptr_t capacity;      /* how many elements actually fit into the allocated space */
    uintptr_t count;         /* number of elements inserted */
