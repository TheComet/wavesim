...
typedef enum wsret
{
    ...
    WS_ERR_READ_ERROR                 = -7,
    WS_ERR_KEY_EXISTS                 = -8,
    WS_ERR_TOO_FEW_INDICES            = -9,
    WS_ERR_INDICES_ARENT_A_TRI        = -10,
    WS_ERR_VERTEX_INDEX_NOT_FOUND     = -11,
    WS_ERR_SIM_MEDIUM_NOT_SET         = -12,
    WS_ERR_SIM_AUDIO_SOURCE_NOT_SET   = -13,
    WS_ERR_SIM_AUDIO_LISTENER_NOT_SET = -14,
} wsret;
